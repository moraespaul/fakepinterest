...
@app.route('/', methods=['GET', 'POST'])  # Rota do Site
def homepage():
    formlogin = FormLogin()
    ...
    return render_template('homepage.htm', form=formlogin)
...
def perfil(id_usuario):
    if int(id_usuario) == int(current_user.id):
        ...
        return render_template('perfil.htm', usuario=current_user, form=form_foto)

    else:
        usuario = Usuario.query.get(int(id_usuario))
        return render_template('perfil.htm', usuario=usuario, form=None)
